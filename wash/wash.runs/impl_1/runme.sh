...
HD_PWD='C:/Users/kli007/wash/wash.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log washMachine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source washMachine.tcl -notrace
