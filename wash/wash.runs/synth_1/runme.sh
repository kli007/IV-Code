...
HD_PWD='C:/Users/kli007/wash/wash.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log washMachine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source washMachine.tcl
