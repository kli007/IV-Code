...
set_property PACKAGE_PIN C17 [get_ports m_clk]                        
     set_property IOSTANDARD LVCMOS33 [get_ports m_clk]
     set_property PULLUP true [get_ports m_clk]
 set_property PACKAGE_PIN B17 [get_ports m_data]                    
     set_property IOSTANDARD LVCMOS33 [get_ports m_data]    
     set_property PULLUP true [get_ports m_data]
