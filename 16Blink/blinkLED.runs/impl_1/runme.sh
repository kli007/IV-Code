...
HD_PWD='C:/Users/kli007/Downloads/blinkLED/blinkLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chainBlink.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chainBlink.tcl -notrace
