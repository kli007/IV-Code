...
HD_PWD='C:/Users/kli007/Downloads/blinkLED/blinkLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chainBlink.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chainBlink.tcl
